...
export default function ServiceCatagoryEdit() {
    ...
    <Drawer>
      <AddCourseWrapper>
        <Paper classes={{ root: "paper" }} direction="row">
          <Grid xs={12} container justify="space-between" alignItems="center">
            <div className="title">
              <Link to="/myservice" className="title backLink text-black">
                <LocalOfferIcon className="icon" /> Service Catagories
              </Link>{" "}
              / Edit Catagory
            </div>
          </Grid>
          ...
          >
            <Grid>
              <CustomButton onClick={submitForm}>Update Catagory</CustomButton>
            </Grid>
          </Grid>
        </Paper>
      </AddCourseWrapper>
