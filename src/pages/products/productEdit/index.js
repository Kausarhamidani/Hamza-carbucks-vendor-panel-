...
export default function EditProducts() {
  const carBrandArray = ["BMW", "Corolla", "Audi", "Honda"];
  const carYearArray = ["2016", "2017", "2018", "2019", "2020", "2021"];
  const carModalArray = ["X6 G06", "X7 G07", "1 Series (F40)"];
  const bodyTypes = ["Sedan", "Micro", "HackBack", "Van"];
  const TransmissionTypes = ["Manual", "Automatic"];
  const FuelTypes = ["Petrol", "Charge", "Diesel"];
  const catagoryTypes = ["Active", "Disabled"];
  const organizedBy = ["Active", "Disabled"];
  ...
  const [carTransmissoin, setCarTransmissoin] = useState(null);
        ...
        <Paper classes={{ root: "paper" }}>
          ...
          <Grid xs={12} container style={{ paddingTop: "10px" }}>
            ...
            >
              <CustomSelect
                category={(a) => modal(a)}
                options={carModalArray}
                label="Select Modal"
                defaultOption="Select Modal"
              />
            </Grid>
            <Grid
              xs={12}
...
//                 <CheckCircleIcon className="icon" /> Products
//               </a>{" "}
//               / Edit Products
//             </div>
//           </Grid>
