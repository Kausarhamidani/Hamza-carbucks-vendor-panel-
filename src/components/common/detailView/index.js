...
export default function DetailView(props) {
  console.log("props in detail view", props);
  const detailData = props.location.detailData;
            ...
            >
              <div className="title">
                <a className="title backLink text-black" onClick={goBack}>
                  <AssignmentIcon className="icon" /> Vendors
                </a>
                / Vendor Details
              </div>
            </Grid>
            ...
            <div className="col-md-10 col-sm-12 m-auto">
              {Object.keys(detailData).map((key) => (
                <div style={{ display: "flex" }}>
                  ...
                  <p className="m-2">{detailData[key]}</p>
                </div>
              ))}
              {/* <div style={{ display: "flex" }}>
